...
<body>
	...
	<section style="height: 100vh;" class="container d-flex justify-content-center align-items-center">
		<div class="d-flex justify-content-center align-items-center flex-column">
			...
			<div class="d-flex justify-content-center align-items-center flex-column">
				<h3 style="font-weight: 200;">Gracias por registrarte en Social Ceep</h3>
				<h3 style="font-weight: 200;">Te hemos enviado en mail de confirmacion a tu correo electronico.</h3>
				<h3 style="font-weight: 200;">Solo sera valido durante 24 horas.</h3>
				<h3 style="font-weight: 200;">Te deseamos mucha suerte y esperamos encontrarte pronto.</h3>
			</div>
