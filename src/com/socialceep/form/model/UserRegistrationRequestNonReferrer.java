package com.socialceep.form.model;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

public class UserRegistrationRequestNonReferrer {
	...
	public UserRegistrationRequestNonReferrer() {
		fillDays();
		fillYear();
	}

	public UserRegistrationRequestNonReferrer(String userNameRegistration, String userLastNameRegistration,
